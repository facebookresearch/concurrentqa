...
parser.add_argument('--indexpath', type=str,
                    default='/checkpoint/simarora/mdr/data/hotpot_index/wiki_index.npy')
parser.add_argument('--corpus_dict', type=str,
                    default='/checkpoint/simarora/mdr/data/hotpot_index/wiki_id2doc.json')
parser.add_argument('--model_path', type=str, default='/checkpoint/simarora/mdr/models/q_encoder.pt')
